  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/kannan.desigan"
            ...
            <li>
              <a
                href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJNwgMWvgGDMhKqVpJDlmPKTwqGpCgTHjzCpRRkdttpPbFvzmVrRRCZwXPJBtFLmSggJCGq"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/kannan-d-560a51247/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with passion by Kannan D 💻🚀</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
